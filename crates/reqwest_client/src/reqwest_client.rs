...
impl ReqwestClient {
    ...
    fn builder(read_timeout: Option<Duration>) -> reqwest::ClientBuilder {
        let builder = reqwest::Client::builder()
            ...
            //
            // Do NOT pass a `read_timeout` unless the caller drives the response
            // body inside the Tokio runtime. reqwest implements the timeout by
            ...
            // our panic hook turns into an abort on the first HTTP body read.
            // Connect-level timeouts are fine because the connect future is
            // driven inside the Tokio runtime.
