            ...
            .children(vec![
                example_group_with_title(
                    ...
                    vec![
                        single_example(
                            "Default",
                            Vector::square(VectorName::ZedXCopilot, size).into_any_element(),
                        ),
                        single_example(
                            "Custom Size",
                            h_flex()
                ...
                example_group_with_title(
                    ...
                    vec![
                        single_example(
                            "Accent Color",
                            Vector::square(VectorName::ZedXCopilot, size)
                                .color(Color::Accent)
                                .into_any_element(),
                        ),
                        single_example(
                ...
                example_group_with_title(
                    ...
                    vec![single_example(
                        "Grid",
                        Vector::square(VectorName::Grid, rems_from_px(100_f32)).into_any_element(),
                    )],
                ),
            ])
            .into_any_element()
...
mod tests {
    ...
    fn vector_path() {
        assert_eq!(
            VectorName::ZedXCopilot.path().as_ref(),
