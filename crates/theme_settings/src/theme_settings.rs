...
pub use crate::schema::{
    ...
    WindowBackgroundContent, customizable_color_overrides, set_customizable_color_override,
...
pub use crate::settings::{
    ...
    clear_window_font_overrides, default_theme, observe_buffer_font_size_adjustment,
    reset_agent_buffer_font_size, reset_agent_ui_font_size, reset_all_font_sizes,
