...
use gpui::{
    ...
    Window, anchored, deferred, div, fill, outline,
...
use multi_buffer::{
    Anchor, ExcerptBoundaryInfo, ExpandExcerptDirection, ExpandInfo, MultiBufferOffset,
...
pub fn render_breadcrumb_text(
    ...
    let element = h_flex().flex_grow(1.0).text_ui(cx);
